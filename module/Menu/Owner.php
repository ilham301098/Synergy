...
<ul class="menu">
	...
	<a class="linkRouter" href="?module=Transaksi/Pembelian">
		<li class="menu menuHeader <?php echo menuActive('Pembelian'); ?> margin-b-8">
			<i class="fa fa-cart-plus margin-r-8 header"></i><div class="menu-name">Pembelian</div>
		</li>
	</a>
...
<ul class="menu">
	...
	<a class="linkRouter" href="?module=Master/mstSupplier">
		<li class="menu menuHeader <?php echo menuActive('Master/mstSupplier'); ?> margin-b-8">
			<i class="fa fa-server margin-r-8 header"></i><div class="menu-name">Supplier</div>
		</li>
	</a>
