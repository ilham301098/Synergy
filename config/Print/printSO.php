...
$pdf->Cell(190,7,'Sales Order',0,1,'C');

$pdf->Ln(2);

$pdf->SetFont('Arial','',10);
$content = mysqli_query($con, "SELECT * FROM trans_part WHERE IDTRANSPART='".$_POST['idKWT']."'");
$dt = mysqli_fetch_assoc($content);

$pdf->Cell(23,4,'No. Kwitansi',0,0);
$pdf->Cell(60,4,': '.$dt['IDTRANSPART'],0,0);
$pdf->Cell(17,4,'',0,0);
$pdf->Cell(90,4,'',0,1);
...
$pdf->Cell(87,4,': '.$dt['BUYERNAME'],0,1);

$pdf->Cell(23,4,'No. Hp',0,0);
$pdf->Cell(60,4,': ',0,0);
$pdf->Cell(17,4,'Alamat',0,0);
$pdf->MultiCell(87,4,': ',0,1);
...
$pdf->Cell(30,5,'Rp '.number_format($totalPart).'  ',0,1,'R');
